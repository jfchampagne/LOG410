...
namespace PrototypeLog410
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            addAnnotationPoint(point1, segment1, 0.25f, 0.25f);
            addAnnotationPoint(point2, segment2, 0.25f, 0.75f);
            addAnnotationPoint(point3, segment3, 0.75f, 0.75f);
            addAnnotationPoint(point4, segment4, 0.75f, 0.25f);
            addAnnotationPoint(point5, segment5, 0.50f, 0.50f);
        }

        private void addAnnotationPoint(PictureBox pictureBox, PictureBox segmentPictureBox, float xFraction, float yFraction)
        {
